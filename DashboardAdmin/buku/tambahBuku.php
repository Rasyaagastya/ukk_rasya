  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="daftarBuku.php">Browse</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="container p-3 mt-5">
      ...
      <form action="" method="post" enctype="multipart/form-data" class="mt-3 p-2">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="id_buku"  id="exampleFormControlInput1" placeholder="example inf01" value="<?php echo $kodebuku ?>" readonly style= " background-color: #3333335b ;" required="required">
        </div>
      </div>

...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar fixed-top shadow-sm">
      <div class="container-fluid p-1">
        <a class="navbar-brand" href="#">
          <img src="../assets/rasya.png" class="logo" alt="logo" width="120px" height="50px">
        </a>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span></div>
      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
          <a href="member/member.php">
            <img src="../assets/dashboardCardMember/1.png" alt="daftar buku" class="imeg" style="max-width: 100%;" width="300px">
          </a>
        </div>
        
        <div class="cardImg">
          <a href="buku/daftarBuku.php">
          <img src="../assets/dashboardCardMember/2.png" alt="daftar buku" class="imeg" style="max-width: 100%;" width="300px">
          </a>
        </div>

        <div class="cardImg">
          <a href="petugas/petugas.php">
          <img src="../assets/dashboardCardMember/5.png" alt="daftar buku" class="imeg" style="max-width: 100%;" width="300px">
          </a>
        </div>
        </div>

...
$username = "root";
$password = "";
$database_name = "perpustakaan_rasya";
...
function pinjamBuku($dataBuku) {
  ...
  $queryPinjam = "INSERT INTO peminjaman(id_peminjaman, id_buku, nisn, id_admin, tgl_peminjaman, tgl_pengembalian,status, harga, no_petgas) VALUES ('', '$idBuku', $nisn, $idAdmin, '$tgl_peminjaman', '$tgl_pengembalian','tidak','$harga', '$no_petgas')";
...
function pengembalian($dataBuku) {
  ...
  $queryPengembalian = "INSERT INTO pengembalian VALUES(null, $idPeminjaman, '$idBuku', $nisn, $idAdmin, '$bukuKembali', '$keterlambatan')";

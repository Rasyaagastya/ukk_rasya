...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang Petugas - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span></div>
      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
          ...
          <img src="../assets/dashboardCardMember/7.png" alt="daftar buku" class="imeg" style="max-width: 100%;" width="300px">
          </a>
        </div>
        </div>
